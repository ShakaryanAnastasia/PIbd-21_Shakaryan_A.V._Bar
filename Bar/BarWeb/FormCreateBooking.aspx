<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormCreateBooking.aspx.cs" Inherits="BarWeb.FormCreateBooking" %>
...
<body>
    ...
    <div>
        ...
        Завсегдатай&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:DropDownList ID="DropDownListHabitue" runat="server" Height="16px" Width="285px">
        </asp:DropDownList>
        <br />
        <br />
        Коктейль &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <asp:DropDownList ID="DropDownListCocktail" runat="server" Height="16px" Width="285px">
        </asp:DropDownList>
        <br />
        <br />
