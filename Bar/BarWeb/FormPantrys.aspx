...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="BarServiceImplement.Implementations.PantryServiceList"></asp:ObjectDataSource>
        </div>
    </form>
</body>
</html>
