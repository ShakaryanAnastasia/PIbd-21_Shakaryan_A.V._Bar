<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormPantrys.aspx.cs" Inherits="BarWeb.FormPantrys" %>
        ...
        <div>
            ...
            <asp:GridView ID="dataGridView" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" ShowHeaderWhenEmpty="True">
                <Columns>
                    ...
                    <asp:BoundField DataField="PantryName" HeaderText="PantryName" SortExpression="PantryName" />
                </Columns>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="BarServiceImplementDataBase.Implementations.PantryServiceDB"></asp:ObjectDataSource>
        </div>
    </form>
</body>
</html>
